...
bool create_renderpass(const NGVRendererSettings *settings, VulkanSetupInfo *setup_info) {
	...
	attachments[0].loadOp                  = settings->accumulation_buffer ? VK_ATTACHMENT_LOAD_OP_LOAD : VK_ATTACHMENT_LOAD_OP_CLEAR;
	attachments[0].storeOp                 = VK_ATTACHMENT_STORE_OP_STORE;
	attachments[0].stencilLoadOp           = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
	attachments[0].stencilStoreOp          = VK_ATTACHMENT_STORE_OP_DONT_CARE;
	attachments[0].initialLayout           = settings->accumulation_buffer ? VK_IMAGE_LAYOUT_GENERAL : VK_IMAGE_LAYOUT_UNDEFINED;
	attachments[0].finalLayout             = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR;
	// depth
	attachments[1].format                  = VK_FORMAT_D32_SFLOAT_S8_UINT;
	attachments[1].samples                 = VK_SAMPLE_COUNT_1_BIT;
	attachments[1].loadOp                  = settings->accumulation_buffer ? VK_ATTACHMENT_LOAD_OP_LOAD : VK_ATTACHMENT_LOAD_OP_CLEAR;
	attachments[1].storeOp                 = VK_ATTACHMENT_STORE_OP_STORE;
	attachments[1].stencilLoadOp           = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
	attachments[1].stencilStoreOp          = VK_ATTACHMENT_STORE_OP_DONT_CARE;
	attachments[1].initialLayout           = settings->accumulation_buffer ? VK_IMAGE_LAYOUT_GENERAL : VK_IMAGE_LAYOUT_UNDEFINED;
