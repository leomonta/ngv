...
/**
 * quick macro to use the automatic `__FILE__` and `__LINE__` macroes that gcc defines
 */
 ...
 * @param[in] `format` the `printf` format to use when printing the variadic arguments
 * @param[in] `...` the variadic arguments to pass to `vprintf`
 *
 */
